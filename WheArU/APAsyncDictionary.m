...
- (id)init
{
    ...
    if (self) {
        ...
        NSString *name = [NSString stringWithFormat:@"com.calvinx3.APAsyncDictionary.%ld", (unsigned long)self.hash];
        _queue = dispatch_queue_create([name cStringUsingEncoding:NSASCIIStringEncoding], DISPATCH_QUEUE_CONCURRENT);
    }
    return self;
}
